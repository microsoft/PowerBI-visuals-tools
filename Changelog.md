...
## 7.1.1
* Marked the MCP server integration as a preview feature and added preview disclaimers to the documentation.
* Added a preview notice when running `pbiviz mcp --init`.
