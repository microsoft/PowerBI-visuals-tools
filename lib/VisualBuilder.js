...
class VisualBuilder extends EventEmitter {
    ...
    _createPbivizJson() {
        return new Promise((resolve, reject) => {
            ...
            let jsContent = fs.readFileSync(path.join(dropPath, 'visual.js')).toString();
            let cssContent = fs.readFileSync(path.join(dropPath, 'visual.css')).toString();
            let capabilities = require(this.visualPackage.buildPath(visualConfig.capabilities));
