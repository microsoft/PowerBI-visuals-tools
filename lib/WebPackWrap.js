...
class WebPackGenerator {
    ...
    static async loadAPIPackage() { // jshint ignore:line
        ...
        const capabilitiesSchema = api.schemas.capabilities;
        const pbivizSchema = api.schemas.pbiviz;
        const dependenciesSchema = api.schemas.dependencies;
        const stringResourcesSchema = api.schemas.stringResources;
