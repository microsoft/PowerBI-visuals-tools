...
class WebPackGenerator {
    ...
    static async loadAPIPackage() { // jshint ignore:line
        ...
        const api = await require(basePath);// jshint ignore:line
        const version =  api.version;
        const capabilitiesSchema = api.schemas.capabilitiesSchema;
        const pbivizSchema = api.schemas.pbivizSchema;
        const dependenciesSchema = api.schemas.dependenciesSchema;
        const stringResourcesSchema = api.schemas.stringResourcesSchema;
        return [version, capabilitiesSchema, pbivizSchema, dependenciesSchema, stringResourcesSchema];
    }
