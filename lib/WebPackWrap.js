...
class WebPackGenerator {
    ...
    static async prepareWebPackConfig(visualPackage, options, tsconfig) {
        ...
        if (tsconfig.compilerOptions.outDir) {
            ...
            if (api === null || (typeof pbiviz.apiVersion !== "undefined" && pbiviz.apiVersion != api.version)) {
        ...
        webpackConfig.plugins.push(
            new BundleAnalyzerPlugin({
                reportFilename: config.build.stats,
            ...
            new ExtraWatchWebpackPlugin({
                files: [
                    pbivizJsonPath,
                    visualPackage.buildPath(pbiviz.capabilities)
                ]
            }),
