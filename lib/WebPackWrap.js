...
class WebPackGenerator {
    ...
    static async prepareWebPackConfig(visualPackage, options, tsconfig) {
        ...
        pluginConfiguration.modules = tsconfig.compilerOptions.outDir !== null;
    ...
    static async applyWebpackConfig(visualPackage, options) {
        ...
        if (tsconfig.compilerOptions.outDir) {
            ...
            await TypescriptCompiler.runWatcher(tsconfig.files, tsconfig.compilerOptions, !options.devMode, pbiviz.visual.guid);
            ...
            await WebPackGenerator.appendExportPowerBINameSpace(visualPackage, tsconfig);
            webpackConfig = await WebPackGenerator.prepareWebPackConfig(visualPackage, options, tsconfig);
        }
        return webpackConfig;
    }
