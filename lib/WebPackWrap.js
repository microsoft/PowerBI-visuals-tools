...
class WebPackGenerator {
    ...
    static appendExportPowerBINameSpace(visualPackage) {
        return new Promise((resolve, reject) => {
            ...
            let visualJSFilePath = visualPackage.buildPath(config.build.dropFolder, visualJsName);
            let visualCompiledSource = visualPackage.buildPath(config.build.dropFolder, visualJsName);
    ...
    static prepareWebPackConfig(visualPackage, options) {
        return new Promise((resolve, reject) => {
            ...
            const visualJsName = config.build.js;
            const visualJSFilePath = visualPackage.buildPath(config.build.dropFolder, visualJsName);
    ...
    static applyWebpackConfig(visualPackage, options) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            TypescriptCompiler
                ...
                .then(() => WebPackGenerator.appendExportPowerBINameSpace(visualPackage))
                .then(() => WebPackGenerator.prepareWebPackConfig(visualPackage, options))
